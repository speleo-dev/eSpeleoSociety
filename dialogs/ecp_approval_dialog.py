...
import os, secrets # Pridaný import secrets
...
from config import secret_manager # Pre prístup k názvu bucketu
...
class ECPApprovalDialog(QDialog):
    def __init__(self, req_details, parent=None):
        ...
        # Načítame ecp_record pomocou photo_hash zo žiadosti
    ...
    def approve(self):
        ...
        # Atribút ecp_hash v self.req_details je photo_hash a nemal by sa meniť na finálny ECP hash.
        # self.req_details.approved_ecp_hash = new_generated_ecp_hash # Tento atribút už neexistuje v modeli EcpRequest
    ...
    def reject_request(self):
        ...
        # Ak by člen mal predtým nejaký ecp_hash, ktorý sa teraz zamietnutím tejto žiadosti stáva neplatným,
        # mohlo by byť vhodné ho tu vynulovať. Ale ak je toto nová žiadosť, ecp_hash člena by mal byť už null.
        # Pre istotu, ak by logika portálu bola iná:
        # if self.member.ecp_hash == self.ecp_record.ecp_hash: # Ak by ecp_hash bol dočasne nastavený
